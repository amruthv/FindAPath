...
public class Main {
    ...
    public static void seeGraphs() {
        ...
        //GraphGRAPH = GraphGenerator.generateCloseProbGraph(500, .001, 0, new double[][] {{-500,500},{-500,500}});
        //new GraphView(g);
        
//        Graph GRAPH = GraphGenerator.generateHierachGraph(500, .6, .05, new double[][] {{-500,500},{-500,500}});
        //new GraphView(g);
    }
    
//  public static Graph GRAPH = GraphGenerator.generateCloseConnectGraph(200, .2, new double[][]{{-500, 500}, {-500, 500}});
//    static Graph GRAPH = GraphGenerator.generateHierachGraph(500, .6, .05, new double[][] {{-500,500},{-500,500}});
    static Graph GRAPH = GraphGenerator.generatePrefGraph(500, 2, 30, 2.5, new double[][] {{-1000,1000},{-1000,1000}});
