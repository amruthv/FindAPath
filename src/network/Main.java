...
public class Main {
	...
	public static void seeGraphs() {
		Graph g = GraphGenerator.generateCloseConnectGraph(200, .14, new double[][] { { -250, 250 }, { -250, 250 } });
	...
	// public static Graph GRAPH = GraphGenerator.generateCloseConnectGraph(100, .1, new double[][]{{-250, 250}, {-250, 250}});
	// public static Graph GRAPH = GraphGenerator.generateCloseProbGraph(200, 10, 30, new double[][]{{-250, 250}, {-250, 250}});
	public static Graph GRAPH = GraphGenerator.generatePrefGraph(200, 5, 30, 2.5, new double[][] { { -250, 250 }, { -250, 250 } });
